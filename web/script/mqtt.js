...
`;
  ...
  var Ad = M((BC, Sd) => {
    ...
    v();
    m();
    var { Buffer: Si } = (be(), X(me)),
      Om = 65536,
      vd = {},
      xm = Si.isBuffer(Si.from([1, 2]).subarray(0, 1));
    function Ed(t) {
  ...
  var Qo = M(($C, xd) => {
    ...
    var j = Ho(),
      ...
      Pn = Ai.cache,
      Fm = Ai.generateNumber,
      Wm = Ai.generateCache,
      Ko = Ai.genBufVariableByteInt,
      $m = Ai.generate4ByteBuffer,
      Te = Go,
      kn = !0;
    function kd(t, e, r) {
      switch (
    ...
    Object.defineProperty(kd, "cacheNumbers", {
      ...
      set(t) {
        t
          ? ((!Pn || Object.keys(Pn).length === 0) && (kn = !0), (Te = Go))
          : ((kn = !1), (Te = r1));
      },
    });
    function Hm(t) {
    ...
    function Vm(t, e, r) {
      ...
      if (s) {
        ...
        if (((S = {}), o === 5)) {
          if (((S = Wt(e, s.properties)), !S)) return !1;
          y += S.length;
        }
      }
      let E = !1;
      if (h != null)
        if (Pd(h)) (E = !0), (y += q.byteLength(h) + 2);
      ...
      return (
        ...
        o === 5 && w.write(),
        Yr(e, c),
        s && (o === 5 && S.write(), wr(e, s.topic), Yr(e, s.payload)),
        h != null && Yr(e, h),
        d != null && Yr(e, d),
        !0
      );
    ...
    function Qm(t, e, r) {
      ...
      for (let g of a) {
        ...
        wr(e, y),
          ...
          i === 5 &&
            ((C |= S ? j.SUBSCRIBE_OPTIONS_NL : 0),
            (C |= E ? j.SUBSCRIBE_OPTIONS_RAP : 0),
    ...
    var y1 = (t, e) => {
      ...
      switch ((t.log("_handleAck :: packet type", i), i)) {
        ...
        case "puback": {
          let a = e.reasonCode;
          a && a > 0 && a !== 16
            ? ((s = new Kd.ErrorWithReasonCode(
                `Publish error: ${$t.ReasonCodes[a]}`,
                a
              )),
  ...
  var Qd = M((sa) => {
    ...
    var Gd = _r(),
      ...
      w1 = (t, e) => {
        ...
        if (i !== 5) {
          let o = new Gd.ErrorWithReasonCode(
        ...
        t.handleAuth(e, (o, s) => {
          ...
          if (n === 24) (t.reconnecting = !1), t._sendPacket(s);
            ...
            let a = new Gd.ErrorWithReasonCode(
  ...
  var ep = M((Mn) => {
    ...
    var Ri =
        ...
        typeof performance.now == "function"
          ...
          : Date,
      Jd = new Set(),
      oa = typeof B == "object" && B ? B : {},
      Xd = (t, e, r, i) => {
        typeof oa.emitWarning == "function"
          ? oa.emitWarning(t, e, r, i)
          : console.error(`[${r}] ${e}: ${t}`);
      },
      xn = globalThis.AbortController,
      Yd = globalThis.AbortSignal;
    if (typeof xn > "u") {
      (Yd = class {
        onabort;
        _onabort = [];
      ...
      let t = oa.env?.LRU_CACHE_IGNORE_AC_WARNING !== "1",
        e = () => {
          t &&
            ((t = !1),
            Xd(
        ...
        *rvalues() {
                ...
                this.#e[r] === y &&
                  (S === void 0
                    ...
                    : (i.status && (i.status.fetchUpdated = !0),
                      this.set(e, S, l.options))),
                S
              );
            },
            h = (S) => (
              i.status &&
                ((i.status.fetchRejected = !0), (i.status.fetchError = S)),
              d(S)
            ),
            d = (S) => {
              let { aborted: E } = s.signal,
                I = E && i.allowStaleOnFetchAbort,
              ...
              I &&
                ...
                s.signal.addEventListener("abort", () => {
                  (!i.ignoreFetchAbort || i.allowStaleOnFetchAbort) &&
                    (S(void 0),
                    i.allowStaleOnFetchAbort && (S = (C) => c(C, !0)));
                });
            };
        ...
        #t(e) {
          ...
          return (
            ...
            r.__abortController instanceof xn
          );
        }
        async fetch(e, r = {}) {
          let {
          ...
          if (U === void 0) {
            ...
            if (this.#t(N)) {
              ...
              return (
                I && ((I.fetch = "inflight"), pe && (I.returnedStale = !0)),
                pe ? N.__staleWhileFetching : (N.__returned = N)
              );
            }
            let W = this.#d(U);
            if (!E && !W)
  ...
  var ut = M((ga) => {
    ...
    v();
    m();
    Object.defineProperty(ga, "t", { value: !0 });
  ...
  var ba = M((Wn) => {
    ...
    var B1 = lt(),
      Fn = ut(),
      ya = class extends B1.ContainerIterator {
        constructor(e, r) {
          super(r),
            (this.o = e),
            this.iteratorType === 0
              ? ((this.pre = function () {
                  return (
                    this.o === 0 && (0, Fn.throwIteratorAccessError)(),
                    (this.o -= 1),
                    this
                  );
                }),
              ...
              : ((this.pre = function () {
                ...
                (this.next = function () {
                  return (
                    this.o === -1 && (0, Fn.throwIteratorAccessError)(),
                    (this.o -= 1),
                    this
                  );
                }));
      ...
      wa = class extends P1.default {
        ...
        find(e) {
          for (let r = 0; r < this.i; ++r)
            if (this.J[r] === e) return new mr(r, this);
          return this.end();
        }
        reverse() {
          this.J.reverse();
  ...
  var sp = M((Hn) => {
    ...
    v();
    m();
    Object.defineProperty(Hn, "t", { value: !0 });
    Hn.default = void 0;
    var M1 = U1(jn()),
      L1 = lt(),
      vr = ut();
    ...
    var Er = class t extends L1.ContainerIterator {
        constructor(e, r, i, n) {
          super(n),
            ...
            this.iteratorType === 0
              ? ((this.pre = function () {
                  return (
                    this.o.L === this.h && (0, vr.throwIteratorAccessError)(),
                    (this.o = this.o.L),
                    this
                  );
                }),
                (this.next = function () {
                  return (
                    this.o === this.h && (0, vr.throwIteratorAccessError)(),
                    (this.o = this.o.B),
                    this
                  );
                }))
              : ((this.pre = function () {
                  return (
                    this.o.B === this.h && (0, vr.throwIteratorAccessError)(),
                    (this.o = this.o.B),
                    this
                  );
                }),
        ...
        get pointer() {
          return (
            this.o === this.h && (0, vr.throwIteratorAccessError)(), this.o.l
          );
        }
        set pointer(e) {
          this.o === this.h && (0, vr.throwIteratorAccessError)(),
      ...
      _a = class extends M1.default {
        ...
        eraseElementByIterator(e) {
          let r = e.o;
          return (
            r === this.h && (0, vr.throwIteratorAccessError)(),
            (e = e.next()),
            this.V(r),
            e
          );
  ...
  var op = M((Vn) => {
    ...
    var Sr = class t extends D1.RandomIterator {
      ...
      ma = class extends q1.default {
        ...
        find(e) {
          for (let r = 0; r < this.i; ++r)
            if (this.getElementByPos(r) === e) return new Sr(r, this);
          return this.end();
        }
        reverse() {
          let e = 0,
      ...
      Ea = class extends W1.Container {
        constructor(
          ...
          super(),
            ...
            (this.v = e),
            r
              ? ((this.re = lp.TreeNodeEnableIndex),
        ...
        updateKeyByIterator(e, r) {
          let i = e.o;
          if (
            (i === this.h && (0, up.throwIteratorAccessError)(), this.i === 1)
          )
            return (i.u = r), !0;
          if (i === this.h.U)
  ...
  var Ia = M((Qn) => {
    ...
    var H1 = lt(),
      Gn = ut(),
      Aa = class extends H1.ContainerIterator {
        constructor(e, r, i) {
          super(i),
            (this.o = e),
            (this.h = r),
            this.iteratorType === 0
              ? ((this.pre = function () {
                  return (
                    this.o === this.h.U && (0, Gn.throwIteratorAccessError)(),
                    (this.o = this.o.L()),
                    this
                  );
                }),
                (this.next = function () {
                  return (
                    this.o === this.h && (0, Gn.throwIteratorAccessError)(),
                    (this.o = this.o.B()),
                    this
                  );
                }))
              : ((this.pre = function () {
                  return (
                    this.o === this.h.W && (0, Gn.throwIteratorAccessError)(),
                    (this.o = this.o.B()),
                    this
                  );
                }),
  ...
  var Ba = M((Ca) => {
    ...
    v();
    m();
    Object.defineProperty(Ca, "t", { value: !0 });
    Ca.default = ev;
    function ev(t) {
      let e = typeof t;
  ...
  var xa = M((ti) => {
    ...
    v();
    m();
    Object.defineProperty(ti, "t", { value: !0 });
      ...
      constructor(e, r, i) {
        super(i),
          ...
          this.iteratorType === 0
            ? ((this.pre = function () {
                return (
                  this.o.L === this.h && (0, Ci.throwIteratorAccessError)(),
                  (this.o = this.o.L),
                  this
                );
              }),
              (this.next = function () {
                return (
                  this.o === this.h && (0, Ci.throwIteratorAccessError)(),
                  (this.o = this.o.B),
                  this
                );
              }))
            : ((this.pre = function () {
                return (
                  this.o.B === this.h && (0, Ci.throwIteratorAccessError)(),
                  (this.o = this.o.B),
                  this
                );
              }),
    ...
    var Oa = class extends pp.Container {
      ...
      eraseElementByIterator(e) {
        let r = e.o;
        return (
          r === this.h && (0, Ci.throwIteratorAccessError)(),
          this.V(r),
          e.next()
        );
      }
  ...
  var yp = M((Xn) => {
    ...
    var gp = xa(),
      rv = ut(),
      Ar = class t extends gp.HashContainerIterator {
        constructor(e, r, i, n) {
          super(e, r, n), (this.container = i);
        }
        get pointer() {
    ...
    var qv = () => {
        ...
        return typeof window < "u"
          ? typeof navigator < "u" &&
            ...
            !(B === null || B === void 0) &&
            B.versions
            ? !Object.prototype.hasOwnProperty.call(B.versions, "electron")
      ...
      Bp = () => typeof navigator < "u" && navigator.product === "ReactNative",
      Dv = qv() || Cp() || Bp();
    Tr.isWebWorker = Cp();
      ...
      var r = function (s) {
        ...
        n = function (s) {
          ...
          var d = function (E) {
              ...
              c.set(I, { timerId: E, timerType: "interval" }),
                a.set(E, I),
                h.postMessage({
                  id: I,
                  method: "clear",
            ...
            g = function (E) {
              var I = e.generateUniqueNumber(c);
              c.set(I, { timerId: E, timerType: "timeout" }),
                l.set(E, I),
                h.postMessage({
                  id: I,
                  method: "clear",
  ...
  var Dp = M((Ct) => {
    ...
    var ja = Wv(Oi()),
      Up = Lp(),
      Np = { set: Up.setInterval, clear: Up.clearInterval },
      qp = { set: (t, e) => setInterval(t, e), clear: (t) => clearInterval(t) },
      $v = (t) => {
        switch (t) {
          case "native":
            return qp;
          ...
          case "auto":
          default:
            return ja.default && !ja.isWebWorker && !ja.isReactNativeBrowser
              ? Np
              : qp;
        }
      };
  ...
  var os = M((Qe) => {
    ...
    var Gv = zt(Gu()),
      ...
      ss = class t extends Zv.TypedEventEmitter {
        static defaultId() {
        ...
        constructor(e, r) {
          ...
          (this.log = this.options.log || (0, Jv.default)("mqttjs:client")),
            ...
            this.options.writeCache ||
              ($a.default.writeToStream.cacheNumbers = !1),
            (this.streamBuilder = e),
            (this.messageIdProvider =
              typeof this.options.messageIdProvider > "u"
                ? new Qv.default()
                : this.options.messageIdProvider),
            (this.outgoingStore = r.outgoingStore || new ii.default()),
            (this.incomingStore = r.incomingStore || new ii.default()),
            (this.queueQoSZero =
        ...
        connect() {
          ...
          let r = new Yv.Writable(),
            i = $a.default.parser(this.options),
            n = null,
            o = [];
          this.log("connect :: calling method to clear reconnect"),
            ...
            this.disconnected &&
              !this.reconnecting &&
              ((this.incomingStore =
                this.options.incomingStore || new ii.default()),
              (this.outgoingStore =
                this.options.outgoingStore || new ii.default()),
              (this.disconnecting = !1),
              (this.disconnected = !1)),
            this.log(
              ...
              h.forEach((E) => {
                if (this.options.reconnectPeriod > 0) {
                  ...
                  n === 5 &&
                    ...
                    (this._resubscribeTopics[E.topic] = I),
                    S.push(E.topic);
                }
              }),
        ...
        _setupKeepaliveManager() {
          this.log(
            ...
            !this.keepaliveManager &&
              this.options.keepalive &&
              (this.keepaliveManager = new eE.default(
                this,
      ...
      (Kp = function (t, e) {
        ...
        (Gp = function (t) {
          ...
          for (let l = s > 0 ? s + 1 : 0; l < r; ) {
            ...
            for (let d = 1, g = 36; ; g += 36) {
              ...
              let y =
                (a = t.charCodeAt(l++)) - 48 < 10
                  ...
                  ? a - 97
                  : 36;
              (y >= 36 || y > dt((2147483647 - i) / d)) && Rr("overflow"),
                (i += y * d);
            ...
            let h = e.length + 1;
            (o = Jp(i - c, h, c == 0)),
              dt(i / h) > 2147483647 - n && Rr("overflow"),
              (n += dt(i / h)),
              (i %= h),
              e.splice(i++, 0, n);
          }
        ...
        (Qp = function (t) {
          ...
          for (s && e.push("-"); a < r; ) {
            ...
            let c = a + 1;
            l - i > dt((2147483647 - n) / c) && Rr("overflow"),
              (n += (l - i) * c),
              (i = l);
            for (let h of t)
        ...
        (Kt = {
          version: "2.1.0",
          ucs2: { decode: Yp, encode: (t) => String.fromCodePoint(...t) },
          decode: Gp,
          encode: Qp,
          toASCII: function (t) {
                  ...
                  .map(function (n) {
                    ...
                    return Array.isArray(t[n])
                      ? t[n]
                          ...
                          .join(e)
                      : o + encodeURIComponent(Mi(t[n]));
                  })
                  .join(e)
              : i
              ? encodeURIComponent(Mi(i)) + r + encodeURIComponent(Mi(t))
              : ""
          );
        }),
        (pt = {});
  ...
  function uE() {
    ni &&
      Cr &&
      ((ni = !1),
      Cr.length ? (Ot = Cr.concat(Ot)) : (as = -1),
      Ot.length && ig());
  }
  function ig() {
    if (!ni) {
  ...
  function cE() {
    ...
    var n = {
      ...
      relative: function (s, a) {
        ...
        for (
          var g = a.length, y = g - d, w = h < y ? h : y, S = -1, E = 0;
          E <= w;
          ++E
        ) {
          if (E === w) {
            if (y > w) {
              ...
              h > w &&
                (s.charCodeAt(l + E) === 47 ? (S = E) : E === 0 && (S = 0));
            break;
          }
          var I = s.charCodeAt(l + E),
            C = a.charCodeAt(d + E);
          if (I !== C) break;
          I === 47 && (S = E);
        }
      ...
      parse: function (s) {
        ...
        c ? ((a.root = "/"), (h = 1)) : (h = 0);
        for (
          var d = -1, g = 0, y = -1, w = !0, S = s.length - 1, E = 0;
          S >= h;
          --S
        ) {
  ...
  function ME(t) {
    ...
    return (
      ...
      !nl && e.includes("\\") && (e = e.replace(RE, "%5C")),
      e.includes(`
`) && (e = e.replace(CE, "%0A")),
  ...
  function pg(t) {
    ...
    return (
      ...
      !sl && e.includes("\\") && (e = e.replace(GE, "%5C")),
      e.includes(`
`) && (e = e.replace(QE, "%0A")),
    ...
    yg = _e(() => {
      ...
      (Z.parse = Li),
        (Z.resolve = function (t, e) {
          return Li(t, !1, !0).resolve(e);
        }),
        (Z.resolveObject = function (t, e) {
          return t ? Li(t, !1, !0).resolveObject(e) : e;
        }),
        (Z.format = function (t) {
          return (
            gt.isString(t) && (t = Li(t)),
...
`,
      ...
      (Fe.prototype.parse = function (t, e, r) {
        ...
        if (r || l || s.match(/^\/\/[^@\/]+@[^@\/]+/)) {
          var h = s.substr(0, 2) === "//";
          !h || (l && el[l]) || ((s = s.substr(2)), (this.slashes = !0));
        }
        if (!el[l] && (h || (l && !ai[l]))) {
          ...
          this.hostname.length > 255
            ...
            E || (this.hostname = hE.toASCII(this.hostname));
          var pe = this.port ? ":" + this.port : "",
            Yt = this.hostname || "";
          (this.host = Yt + pe),
            (this.href += this.host),
            E &&
        ...
        if (
          (Or !== -1
            ? ((this.search = s.substr(Or)),
              (this.query = s.substr(Or + 1)),
              e && (this.query = tl.parse(this.query)),
              (s = s.slice(0, Or)))
            : e && ((this.search = ""), (this.query = {})),
          s && (this.pathname = s),
          ai[c] && this.hostname && !this.pathname && (this.pathname = "/"),
        ...
        (Fe.prototype.format = function () {
          ...
          this.host
            ...
            this.query &&
              ...
              (o = tl.stringify(this.query));
          var s = this.search || (o && "?" + o) || "";
          return (
            e && e.substr(-1) !== ":" && (e += ":"),
            this.slashes || ((!e || ai[e]) && n !== !1)
              ? ((n = "//" + (n || "")),
                r && r.charAt(0) !== "/" && (r = "/" + r))
              : n || (n = ""),
            i && i.charAt(0) !== "#" && (i = "#" + i),
        ...
        (Fe.prototype.resolve = function (t) {
          return this.resolveObject(Li(t, !1, !0)).format();
        }),
        (Fe.prototype.resolveObject = function (t) {
          ...
          var Q,
            pe = R[0] === "" || (R[0] && R[0].charAt(0) === "/");
          return (
            U &&
              ((r.hostname = r.host = pe ? "" : R.length ? R.shift() : ""),
              (Q =
                !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) &&
                ((r.auth = Q.shift()), (r.host = r.hostname = Q.shift()))),
            (I = I || (r.host && R.length)) && !pe && R.unshift(""),
            R.length
              ? (r.pathname = R.join("/"))
  ...
  var Ui = M((Qt) => {
    ...
    var us = (be(), X(me)),
      ...
      iS = ll(Oi()),
      al = ls(),
      Gt = (0, tS.default)("mqttjs:ws"),
      nS = ["rejectUnauthorized", "ca", "cert", "key", "pfx", "passphrase"];
    function Eg(t, e) {
    ...
    function oS(t, e, r) {
      ...
      return (
        r.createWebsocket
          ...
          : (n = new vg.default(e, [i], r.wsOptions)),
        n
      );
    }
    function aS(t, e) {
    ...
    var lS = (t, e) => {
      ...
      let i = Eg(r, t),
        n = oS(t, i, r),
        o = vg.default.createWebSocketStream(n, r.wsOptions);
      return (
        (o.url = i),
        n.on("close", () => {
          o.destroy();
    ...
    var uS = (t, e) => {
      ...
      let r,
        n = sS(e).browserBufferSize || 1024 * 512,
        o = e.browserBufferTimeout || 1e3,
        s = !e.objectMode,
        a = aS(t, e),
        l = h(e, S, E);
      e.objectMode || (l._writev = al.writev.bind(l)),
        l.on("close", () => {
          a.close();
        });
      ...
      function d() {
        Gt("WebSocket onOpen"),
          r instanceof al.BufferedDuplex && r.socketReady();
      }
      function g(I) {
      ...
      async function w(I) {
        ...
        C instanceof ArrayBuffer
          ? (C = us.Buffer.from(C))
          : C instanceof Blob
          ? (C = us.Buffer.from(await new Response(C).arrayBuffer()))
          : (C = us.Buffer.from(C, "utf8")),
          l && !l.destroyed && l.push(C);
      }
      function S(I, C, R) {
    ...
    var cS = Ag((fl(), X(ul))),
      ...
      pS = (t, e) => {
        ...
        let { port: r, path: i } = e,
          n = e.hostname;
        return (
          dS("port %d and host %s", r, n),
          cS.default.createConnection({ port: r, host: n, path: i })
        );
      };
    Ni.default = pS;
  });
  ...
  var dl = M((qi) => {
    ...
    var yS = hl((Tg(), X(Ig))),
      bS = hl((fl(), X(ul))),
      wS = hl(ot()),
      _S = (0, wS.default)("mqttjs:tls"),
      mS = (t, e) => {
        (e.port = e.port || 8883),
          (e.host = e.hostname || e.host || "localhost"),
          bS.default.isIP(e.host) === 0 && (e.servername = e.host),
  ...
  var yl = M((gl) => {
    ...
    var RS = (t, e) => {
      ...
      (yt = wx.connectSocket({ url: i, protocols: [r] })),
        (pl = SS()),
        (Le = new ES.BufferedDuplex(e, pl, yt)),
        (Le._destroy = (o, s) => {
          yt.close({
            success() {
              s && s(o);
  ...
  var _l = M((wl) => {
    ...
    var MS = (t, e) => {
      ...
      return (
        ...
        (fs = PS()),
        (ui = new BS.BufferedDuplex(e, fs, xt)),
        xS(),
        ui
      );
    };
  ...
  var kg = M((Br) => {
    ...
    function Pg(t, e) {
      ...
      if (
        (de ||
          ((de = {}),
          !qS.default && !e.forceNativeWebSocket
            ? ((de.ws = Ui().streamBuilder),
              (de.wss = Ui().streamBuilder),
              (de.mqtt = cl().default),
              (de.tcp = cl().default),
              (de.ssl = dl().default),
              (de.tls = de.ssl),
              (de.mqtts = dl().default))
            : ((de.ws = Ui().browserStreamBuilder),
              (de.wss = Ui().browserStreamBuilder),
              (de.wx = yl().default),
              (de.wxs = yl().default),
              (de.ali = _l().default),
              (de.alis = _l().default))),
        ...
        e.protocol = [
          ...
          l && h % 2 === 0 ? !1 : typeof de[c] == "function"
        )[0];
      }
